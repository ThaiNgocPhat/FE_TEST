...
public class UserAnswerServiceImpl implements IUserAnswerService {
    ...
    @Override
    public ResponseWrapper<String> submitAnswers(List<UserAnswerDto> userAnswers) {
        ...
        ExamResult examResult = ExamResult.builder()
                .userId(userAnswers.get(0).getUserId())
    ...
    @Override
    public ResponseWrapper<UserExamResultDto> getUserExamResult(Long userId, Long examId, SessionType sessionType) {
        List<Question> questions = questionRepository.findByExamSession_Exam_IdAndExamSession_SessionType(examId, sessionType);
        ...
        List<UserAnswer> userAnswers = userAnswerRepository.findByUserAndQuestionIdsAndSessionType(
                userId, questionIds, sessionType
        );
